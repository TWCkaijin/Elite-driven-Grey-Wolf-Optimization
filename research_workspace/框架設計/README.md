...
| EDGWO+Attn.   | 整合注意力機制               | 特徵穩定性 (Jaccard 相似度) |
| EDGWO+PCA    | 使用 PCA 降維替代注意力機制  | 計算效率、特徵解釋性 |
...
## 範例；
### 敏感度熱力圖
- 目標：驗證您提出的改進算法（如REINEDGWO）在面對不同雜訊（高斯雜訊、缺失數據、冗餘特徵等）時，是否比其他傳統算法（如標準GWO、NSGA-II）更穩定。
圖表意義：
